#pragma once
static FILE *inputfile, *VirtRdOBJ; // Track file
...
static bool version3DO = false; // Turns on if 3DO version and enables reversed track extraction
...
const int numOBJParams = 64; // Quantity of the Object's params
const float FENCEHEIGHT = 0.12; // Fence height (scenery block)
const unsigned int numSceneryIndexes = numVirtRdIndexes/4; // Quantity of Scenery records
//const int TRACKDEPTH = 12; // Quantity of rendered scenery blocks for 3DO inverted track
...
//static VirtRd_t VIRTUALROADARRAY[numVirtRdIndexes];
